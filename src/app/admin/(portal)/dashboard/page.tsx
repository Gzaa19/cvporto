        ...
        <div className="space-y-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="p-6 rounded-lg border border-white/10 bg-[#1a1a2e]">
                    ...
                    <Link href="/admin/hero" className="text-primary hover:underline font-mono text-sm">Manage Hero &rarr;</Link>
                </div>
                ...
                <div className="p-6 rounded-lg border border-white/10 bg-[#1a1a2e]">
                    ...
                    <Link href="/admin/about" className="text-primary hover:underline font-mono text-sm">Manage About &rarr;</Link>
                </div>
            </div>
        </div>
    );
